  ...
  const renderItem = ({ item }: { item: Notification }) => (
    <TouchableOpacity 
      ...
      <View style={styles.iconContainer}>
        <View style={[styles.iconBackground, !item.isRead && styles.unreadIconBackground]}>
            <MaterialIcons
      ...
      <View style={styles.textContainer}>
        <CustomText variant={!item.isRead ? "bold" : "medium"} style={[styles.title, !item.isRead && styles.unreadText]} numberOfLines={1}>
            {item.title}
        </CustomText>
    ...
    <View style={styles.container}>
      {isLoading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.centerContainer}>
                <CustomText style={styles.emptyText}>Chưa có thông báo nào.</CustomText>
            </View>
          }
        />
      )}

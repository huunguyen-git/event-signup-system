...
import { View, StyleSheet, TextInput, Text, TouchableOpacity, Alert, Platform, ActivityIndicator } from "react-native";
                ...
                <View style={styles.input}>
                    ...
                    >
                        ...
                        <Text
                            style={[
                                styles.textInput,
                                { color: birthdate ? Colors.color.text : Colors.color.placeholder }
                            ]} 
                        >
